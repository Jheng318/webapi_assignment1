...
// 1 function (search the posts by a given title)
server.searchPostsByTitle("What is the cosmere?"); // test filter function that will return a valid posts
console.log("\n");
server.searchPostsByTitle(); //  test exception to handle no title being found
console.log("\n");
server.searchPostsByTitle("nani"); // test exception that handles a posts that is not found with the provided title in the database
